            ...
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="text" name="subtitle[ar]" value="{{ old('subtitle.ar', $article->subtitle['ar'] ?? '') }}" class="w-full px-4 py-3.5 bg-gray-50 border border-gray-200 rounded-2xl focus:bg-white focus:ring-4 focus:ring-primary/10 font-bold">
                    </div>
                    <div class="space-y-2" dir="ltr">
                        <label class="block text-sm font-black text-gray-700 text-right">Subtitle (English)</label>
                        <input type="text" name="subtitle[en]" value="{{ old('subtitle.en', $article->subtitle['en'] ?? '') }}" class="w-full px-4 py-3.5 bg-gray-50 border border-gray-200 rounded-2xl focus:bg-white focus:ring-4 focus:ring-primary/10 font-bold text-left">
                    </div>
                </div>
            </div>
            ...
            <div class="space-y-6 pt-6 mt-6 border-t border-gray-100">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-2">
                        ...
                        <textarea name="description[ar]" rows="4" required class="w-full px-4 py-3.5 bg-gray-50 border border-gray-200 rounded-2xl focus:bg-white focus:ring-4 focus:ring-primary/10 font-bold resize-y">{{ old('description.ar', $article->description['ar'] ?? '') }}</textarea>
                    </div>
                    <div class="space-y-2" dir="ltr">
                        <label class="block text-sm font-black text-gray-700 text-right">Central Thesis (English) <span class="text-red-500">*</span></label>
                        <textarea name="description[en]" rows="4" required class="w-full px-4 py-3.5 bg-gray-50 border border-gray-200 rounded-2xl focus:bg-white focus:ring-4 focus:ring-primary/10 font-bold resize-y text-left">{{ old('description.en', $article->description['en'] ?? '') }}</textarea>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-2">
                        ...
                        <textarea name="article_body[ar]" rows="6" class="w-full px-4 py-3.5 bg-gray-50 border border-gray-200 rounded-2xl focus:bg-white focus:ring-4 focus:ring-primary/10 font-bold resize-y">{{ old('article_body.ar', $article->article_body['ar'] ?? '') }}</textarea>
                    </div>
                    <div class="space-y-2" dir="ltr">
                        <label class="block text-sm font-black text-gray-700 text-right">Article Body (English)</label>
                        <textarea name="article_body[en]" rows="6" class="w-full px-4 py-3.5 bg-gray-50 border border-gray-200 rounded-2xl focus:bg-white focus:ring-4 focus:ring-primary/10 font-bold resize-y text-left">{{ old('article_body.en', $article->article_body['en'] ?? '') }}</textarea>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-2">
                        ...
                        <textarea name="central_concepts[ar]" rows="4" class="w-full px-4 py-3.5 bg-gray-50 border border-gray-200 rounded-2xl focus:bg-white focus:ring-4 focus:ring-primary/10 font-bold resize-y">{{ old('central_concepts.ar', $article->central_concepts['ar'] ?? '') }}</textarea>
                    </div>
                    <div class="space-y-2" dir="ltr">
                        <label class="block text-sm font-black text-gray-700 text-right">Central Concepts (English)</label>
                        <textarea name="central_concepts[en]" rows="4" class="w-full px-4 py-3.5 bg-gray-50 border border-gray-200 rounded-2xl focus:bg-white focus:ring-4 focus:ring-primary/10 font-bold resize-y text-left">{{ old('central_concepts.en', $article->central_concepts['en'] ?? '') }}</textarea>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-2">
                        ...
                        <textarea name="analytical_mechanism[ar]" rows="4" class="w-full px-4 py-3.5 bg-gray-50 border border-gray-200 rounded-2xl focus:bg-white focus:ring-4 focus:ring-primary/10 font-bold resize-y">{{ old('analytical_mechanism.ar', $article->analytical_mechanism['ar'] ?? '') }}</textarea>
                    </div>
                    <div class="space-y-2" dir="ltr">
                        <label class="block text-sm font-black text-gray-700 text-right">Analytical Mechanism (English)</label>
                        <textarea name="analytical_mechanism[en]" rows="4" class="w-full px-4 py-3.5 bg-gray-50 border border-gray-200 rounded-2xl focus:bg-white focus:ring-4 focus:ring-primary/10 font-bold resize-y text-left">{{ old('analytical_mechanism.en', $article->analytical_mechanism['en'] ?? '') }}</textarea>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-2">
                        ...
                        <textarea name="why_it_matters[ar]" rows="4" class="w-full px-4 py-3.5 bg-gray-50 border border-gray-200 rounded-2xl focus:bg-white focus:ring-4 focus:ring-primary/10 font-bold resize-y">{{ old('why_it_matters.ar', $article->why_it_matters['ar'] ?? '') }}</textarea>
                    </div>
                    <div class="space-y-2" dir="ltr">
                        <label class="block text-sm font-black text-gray-700 text-right">Why It Matters (English)</label>
                        <textarea name="why_it_matters[en]" rows="4" class="w-full px-4 py-3.5 bg-gray-50 border border-gray-200 rounded-2xl focus:bg-white focus:ring-4 focus:ring-primary/10 font-bold resize-y text-left">{{ old('why_it_matters.en', $article->why_it_matters['en'] ?? '') }}</textarea>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-2">
                        ...
                        <textarea name="talat_ai_questions[ar]" rows="4" class="w-full px-4 py-3.5 bg-gray-50 border border-gray-200 rounded-2xl focus:bg-white focus:ring-4 focus:ring-primary/10 font-bold resize-y">{{ old('talat_ai_questions.ar', $article->talat_ai_questions['ar'] ?? '') }}</textarea>
                    </div>
                    <div class="space-y-2" dir="ltr">
                        <label class="block text-sm font-black text-gray-700 text-right">🤖 Talat AI Questions (English)</label>
                        <textarea name="talat_ai_questions[en]" rows="4" class="w-full px-4 py-3.5 bg-gray-50 border border-gray-200 rounded-2xl focus:bg-white focus:ring-4 focus:ring-primary/10 font-bold resize-y text-left">{{ old('talat_ai_questions.en', $article->talat_ai_questions['en'] ?? '') }}</textarea>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-2">
                        ...
                        <textarea name="sovereign_summary[ar]" rows="4" class="w-full px-4 py-3.5 bg-gray-50 border border-gray-200 rounded-2xl focus:bg-white focus:ring-4 focus:ring-primary/10 font-bold resize-y">{{ old('sovereign_summary.ar', $article->sovereign_summary['ar'] ?? '') }}</textarea>
                    </div>
                    <div class="space-y-2" dir="ltr">
                        <label class="block text-sm font-black text-gray-700 text-right">Sovereign Summary (English)</label>
                        <textarea name="sovereign_summary[en]" rows="4" class="w-full px-4 py-3.5 bg-gray-50 border border-gray-200 rounded-2xl focus:bg-white focus:ring-4 focus:ring-primary/10 font-bold resize-y text-left">{{ old('sovereign_summary.en', $article->sovereign_summary['en'] ?? '') }}</textarea>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-2">
                        ...
                        <textarea name="related_materials[ar]" rows="3" class="w-full px-4 py-3.5 bg-gray-50 border border-gray-200 rounded-2xl focus:bg-white focus:ring-4 focus:ring-primary/10 font-bold resize-y">{{ old('related_materials.ar', $article->related_materials['ar'] ?? '') }}</textarea>
                    </div>
                    <div class="space-y-2" dir="ltr">
                        <label class="block text-sm font-black text-gray-700 text-right">Related Materials (Keywords) (English)</label>
                        <textarea name="related_materials[en]" rows="3" class="w-full px-4 py-3.5 bg-gray-50 border border-gray-200 rounded-2xl focus:bg-white focus:ring-4 focus:ring-primary/10 font-bold resize-y text-left">{{ old('related_materials.en', $article->related_materials['en'] ?? '') }}</textarea>
                    </div>

                    <div class="space-y-2">
                        <label class="block text-sm font-black text-gray-700">بيانات النشر والوسوم بالعربية</label>
                        <textarea name="publishing_data_tags[ar]" rows="3" class="w-full px-4 py-3.5 bg-gray-50 border border-gray-200 rounded-2xl focus:bg-white focus:ring-4 focus:ring-primary/10 font-bold resize-y">{{ old('publishing_data_tags.ar', $article->publishing_data_tags['ar'] ?? '') }}</textarea>
                    </div>
                    <div class="space-y-2" dir="ltr">
                        <label class="block text-sm font-black text-gray-700 text-right">Publishing Data & Tags (English)</label>
                        <textarea name="publishing_data_tags[en]" rows="3" class="w-full px-4 py-3.5 bg-gray-50 border border-gray-200 rounded-2xl focus:bg-white focus:ring-4 focus:ring-primary/10 font-bold resize-y text-left">{{ old('publishing_data_tags.en', $article->publishing_data_tags['en'] ?? '') }}</textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="space-y-6 pt-6 mt-6 border-t border-gray-100">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-2 p-4 bg-gray-50 rounded-2xl border border-gray-100 relative">
                        <label class="block text-sm font-black text-gray-800 mb-2">📊 انفوجرافيك ديزاين</label>
                        @if($article->infographic_design_file)
                            <a href="{{ asset($article->infographic_design_file) }}" target="_blank" class="absolute top-4 left-4 text-[10px] font-bold bg-green-100 text-green-700 px-2 py-1 rounded-lg">ملف موجود ✔️</a>
                        @endif
                        <input type="file" name="infographic_design_file" accept=".pdf,.doc,.docx" class="w-full text-sm file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-black file:bg-primary file:text-white cursor-pointer mt-2">
                    </div>

                    <div class="space-y-2 p-4 bg-gray-50 rounded-2xl border border-gray-100 relative">
                        <label class="block text-sm font-black text-gray-800 mb-2">🖱️ انفوجرافيك تفاعلي</label>
                        @if($article->interactive_infographic_file)
                            <a href="{{ asset($article->interactive_infographic_file) }}" target="_blank" class="absolute top-4 left-4 text-[10px] font-bold bg-green-100 text-green-700 px-2 py-1 rounded-lg">ملف موجود ✔️</a>
                        @endif
                        <input type="file" name="interactive_infographic_file" accept=".pdf,.doc,.docx" class="w-full text-sm file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-black file:bg-primary file:text-white cursor-pointer mt-2">
                    </div>
                </div>
            </div>
