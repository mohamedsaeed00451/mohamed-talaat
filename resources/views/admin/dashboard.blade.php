        ...
        <div class="mb-12">
            <div class="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-6 px-2">
                <div class="flex items-center gap-3">
                    <div class="p-2.5 bg-gradient-to-br from-gray-800 to-gray-900 rounded-xl shadow-lg shadow-gray-900/20 text-white">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z"></path></svg>
                    </div>
                    <div>
                        <h2 class="text-2xl font-black text-gray-900 tracking-tight">التوزيع على منصات التواصل</h2>
                        <p class="text-xs font-bold text-gray-500 mt-1">المقالات التي تم إرسالها آلياً للمنصات المختلفة</p>
                    </div>
                </div>
            </div>

            <div class="grid grid-cols-2 lg:grid-cols-4 gap-6">
                <div class="group glass-card rounded-[2rem] p-6 shadow-sm hover:shadow-[0_15px_30px_rgba(24,119,242,0.15)] hover:border-[#1877F2]/40 hover:-translate-y-1.5 transition-all duration-500 overflow-hidden relative">
                    <div class="absolute -right-4 -top-4 w-24 h-24 bg-[#1877F2]/15 rounded-full blob-glow pointer-events-none"></div>
                    <div class="relative z-10 flex items-center justify-between">
                        ...
                        <div class="w-14 h-14 rounded-[1.2rem] bg-[#1877F2]/10 border border-[#1877F2]/20 flex items-center justify-center text-[#1877F2] transform group-hover:scale-110 group-hover:rotate-6 transition-all duration-500 shadow-sm">
                ...
                <div class="group glass-card rounded-[2rem] p-6 shadow-sm hover:shadow-[0_15px_30px_rgba(0,0,0,0.15)] hover:border-gray-900/40 hover:-translate-y-1.5 transition-all duration-500 overflow-hidden relative">
                    <div class="absolute -right-4 -top-4 w-24 h-24 bg-gray-500/15 rounded-full blob-glow pointer-events-none"></div>
                    <div class="relative z-10 flex items-center justify-between">
                        <div class="flex flex-col gap-1">
                        ...
                        <div class="w-14 h-14 rounded-[1.2rem] bg-gray-100 border border-gray-200 flex items-center justify-center text-gray-900 transform group-hover:scale-110 group-hover:rotate-6 transition-all duration-500 shadow-sm">
                            <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.008 5.922H5.078z"/></svg>
                        </div>
                    </div>
                </div>

                <div class="group glass-card rounded-[2rem] p-6 shadow-sm hover:shadow-[0_15px_30px_rgba(10,102,194,0.15)] hover:border-[#0A66C2]/40 hover:-translate-y-1.5 transition-all duration-500 overflow-hidden relative">
                    <div class="absolute -right-4 -top-4 w-24 h-24 bg-[#0A66C2]/15 rounded-full blob-glow pointer-events-none"></div>
                    <div class="relative z-10 flex items-center justify-between">
                        <div class="flex flex-col gap-1">
                        ...
                        <div class="w-14 h-14 rounded-[1.2rem] bg-[#0A66C2]/10 border border-[#0A66C2]/20 flex items-center justify-center text-[#0A66C2] transform group-hover:scale-110 group-hover:-rotate-6 transition-all duration-500 shadow-sm">
                ...
                <div class="group glass-card rounded-[2rem] p-6 shadow-sm hover:shadow-[0_15px_30px_rgba(225,48,108,0.15)] hover:border-[#E1306C]/40 hover:-translate-y-1.5 transition-all duration-500 overflow-hidden relative">
                    <div class="absolute -right-4 -top-4 w-24 h-24 bg-[#E1306C]/15 rounded-full blob-glow pointer-events-none"></div>
                    <div class="relative z-10 flex items-center justify-between">
                        <div class="flex flex-col gap-1">
                        ...
                        <div class="w-14 h-14 rounded-[1.2rem] bg-gradient-to-tr from-[#F58529] via-[#DD2A7B] to-[#8134AF] flex items-center justify-center text-white transform group-hover:scale-110 group-hover:-rotate-6 transition-all duration-500 shadow-md shadow-[#DD2A7B]/30">
